...
export default async function save(service: Service, path:string | null = null, config:any | null  = {}, record: Element,keys: Array<string> | null = null ): Promise<never[]|Record<string, unknown>|[]|null>
{
